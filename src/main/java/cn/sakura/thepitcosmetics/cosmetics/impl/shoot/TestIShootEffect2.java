...
public class TestIShootEffect2 extends AbstractEffect {
    ...
    public void handleShoot(Player player, Arrow arrow) {
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                Location arrowLoc2 = arrow.getLocation();

                for (int i = 0; i < 2; i++) {
                    arrow.getWorld().playEffect(arrowLoc2, Effect.LAVA_POP, 0);
                }
            }
